...
<div class="content-header">
    <h2>Selecciones</h2>
    <p>Gestión de selecciones nacionales</p>
</div>
...
<div class="cat-layout">
    ...
    <div class="cat-table-wrap">
        <div class="cat-table-header">
            <span>{{ $selecciones->count() }} selección/es registrada(s)</span>
        </div>
        @if($selecciones->isEmpty())
            <p class="empty-state">No hay selecciones todavía.</p>
        @else
                ...
                <tr>
                    ...
                    <td>
                        <div class="row-actions">
                            ...
                            <form method="POST" action="{{ route('admin.selecciones.destroy', $item->cod_sel) }}"
    ...
    <div class="cat-side">
        <div class="side-card">
            <div class="side-card-title">Añadir selección</div>
            <form method="POST" action="{{ route('admin.selecciones.store') }}">
                @csrf
                <div class="side-field">
                    <label>Nombre</label>
                    <input type="text" name="nombre" class="side-input @error('nombre') is-invalid @enderror"
                           value="{{ old('nombre') }}" placeholder="Ej: España" required>
...
function openEdit(id, nombre) {
    ...
    document.getElementById('editForm').action = '/admin/selecciones/' + id;
